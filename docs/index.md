...
This site walks through Kerson Huang's *Statistical Mechanics* (2nd Edition) chapter by chapter, but in plain language — the kind you'd use explaining it to a friend over coffee.
...
!!! tip "Recommended"
    If you do MD simulations, check the [Reading Order](reading-order.md) for a path that starts from what you already know.
...
*Found a mistake? Think something could be explained better? [Open an issue](https://github.com/crisnapatel/statistical-mechanics/issues).*
